...
Widget.reset_widget=function(force){document.querySelector('.edit-icons-user-actions .only_registered').classList.add('hidden');document.querySelector('.edit-icons-user-actions .free_user_warning').classList.add('hidden');document.querySelector('.edit-icons-user-actions .collection_limit').classList.add('hidden');document.querySelector(".edit-icon-content .edit-icons-user-actions #download_button").classList.remove('hidden');document.querySelector('.edit-icons-user-actions .collection_locked').classList.add('hidden');document.getElementById('save_into_active').classList.remove('hidden');document.getElementById('save_into_active').disabled='';document.getElementById('duplicate_icon').disabled='';}
...
ev.stopPropagation();};if(!Element.prototype.hasOwnProperty("parent")){Element.prototype.parent=function(s){var list=this.parents(s);if(typeof s=="undefined")list.reverse();return(list&&list.length)?list[0]:null;};}
